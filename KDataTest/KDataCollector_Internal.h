...
extern NSString *const KDataCollectorPostKeyTotalDisk;
...
extern NSString *const KDataCollectorPostKeyTotalDiskElapsedTime;
...
extern NSString *const KDataCollectorRegExURL;
extern NSString *const KDataCollectorRegExMerchantID;
extern NSString *const KDataCollectorRegExSessionID;
...
// This method is exposed for individual collectors to route their debug messages through
- (void)debugMessage:(NSString *)string debugDelegate:(nullable id<KDataCollectorDebugDelegate>)debugDelegate;

...
- (void)collectLocation 
{
    ...
    CLAuthorizationStatus auth = [NSClassFromString([self locationManagerClassName]) authorizationStatus];
    ...
    if ((kCLAuthorizationStatusRestricted == auth) || ![NSClassFromString([self locationManagerClassName]) locationServicesEnabled]) {
